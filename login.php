                        ...
                        <form role="form" method = "post" enctype = "multipart/form-data" class="index-form">
                            ...
                            <center>Voter Login</center>
                             ...
                             <br/>
                                ...
                                &nbsp; 
                            <a  href="register/index.php"><button type="button" class="btn btn-lg btn-success btn-block" data-dismiss="modal" style="margin-bottom:0px;background-color: #166961;">Registration</button></a>
